  ...
  outputs = { self, nixpkgs, flake-utils, poetry2nix }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        webcounter = { poetry2nix, lib }: poetry2nix.mkPoetryApplication {
          projectDir = self;
        ...
        pkgs = import nixpkgs {
          ...
          overlays = [
            ...
            (final: _: {
              webcounter = final.callPackage webcounter { };
            })
          ];
        };
      in
      {
        packages.default = pkgs.webcounter;
        devShells = {
          ...
          default = pkgs.mkShell {
            inputsFrom = [ pkgs.webcounter ];
            packages = [ pkgs.chromedriver pkgs.geckodriver ];
          };
